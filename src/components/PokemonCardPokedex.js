        ...
        <Card>
            <CardActionArea className={styles.card}>
                <Grid item xs={12} className={styles.displayLeft + " " + styles.favoritesBtn}>
                    {
                    pokemonIsInPokedex ?                    
                        <i className="fa-solid fa-star" onClick={()=>{removePokemonFromMyPokedex(pokemon.name)}}></i>
                    :
                        <i className="fa-regular fa-star" onClick={()=>{addPokemonToMyPokedex(pokemon.name)}}></i>              
                    }
                </Grid>
