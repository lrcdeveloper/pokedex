          ...
          {pokemonData && (
            <>
              <Grid item xs={12} sm={5} md={5} className={styles.boxImage}>
                <Image width={900} height={900} src={pokemonData.image} alt="portada" className="portada" />
              </Grid>
                    ...
                    <Grid item xs={12} sm={12} md={2} className={styles.boxAddFavorites}>
                      {pokemonIsInPokedex ? (
                        <i
                          ...
                          onClick={() => {
                            removePokemonFromMyPokedex(pokemonData.name);
                          }}
                        ></i>
                      ) : (
                        <i
                          ...
                          onClick={() => {
                            addPokemonToMyPokedex(pokemonData.name);
                          }}
                        ></i>
                      )}
                    </Grid>
                  ...
                  <Grid container spacing={2} className={styles.boxTypes}>
                    ...
                    {pokemonData.types.map((type, index) => (
                      <Grid item xs={6} sm={4} md={4} key={index}>
                        <div className={styles.boxType}>{type}</div>
                      </Grid>
                    ))}
                  </Grid>
